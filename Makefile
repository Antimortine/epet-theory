...
# --- Имена файлов ---
OUTPUT_PDF = output/EPET_Theory_1.3.pdf
ANONYMOUS_PDF_OUTPUT = output/EPET_Manuscript_Anonymous_1.3.pdf
SM_PDF_OUTPUT = output/EPET_Supplementary_Materials_1.3.pdf
