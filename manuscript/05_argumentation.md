...
-   **Scientific data:** Consciousness demonstrably depends on the functioning brain, exhibits gradual development, and relies on dynamic neural activity, with its level often correlating with measures of neural complexity and integration, consistent with an emergent process view [@plumDiagnosisStuporComa1982, p. 3; @laureysNeuralCorrelateAwareness2005, p. 557; @trevarthenInfantIntersubjectivityResearch2001, p. 3; @varelaBrainwebPhaseSynchronization2001, p. 229; @tononiIntegratedInformationTheory2016, p. 459].
...
-   **Scientific data:** PP successfully explains diverse perceptual and cognitive phenomena, and neural evidence for prediction and error signals (e.g., Mismatch Negativity) is accumulating [@fristonFreeenergyPrincipleUnified2010, p. 3, 9; @clarkWhateverNextPredictive2013, p. 186; @hohwyPredictiveMind2013, p. 239; @naatanenMismatchNegativityMMN2007, pp. 2571–2572].
...
-   **Scientific data:** PP compellingly explains phenomena like hallucinations, and NCCs for specific content often map to brain areas generating high-level representations [@sterzerPredictiveCodingAccount2018, p. 635].
...
-   **Scientific data:** Neural synchronization, recurrent processing, and global availability (GWT) are proposed mechanisms for solving the 'binding problem' [@singerNeuronalSynchronyVersatile1999; @lammeDistinctModesVision2000; @baarsCognitiveTheoryConsciousness1993, pp. 292–294; @treismanBindingProblem1996].
